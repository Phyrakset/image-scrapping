...
def load_model(model_key_or_id: str):
    ...
    if config:
        ...
        # Fallback to direct path or key
    ...
    print(f"[✓] Model '{model_key}' successfully loaded into GPU VRAM and ready!")
...
async def txt2img(req: Txt2ImgRequest):
    ...
    # Load model on-demand if different from currently loaded
    ...
    target_cfg = req.cfg_scale or config.get("cfg", 6.5)
...
if __name__ == "__main__":
    ...
    # Pre-load initial default model
